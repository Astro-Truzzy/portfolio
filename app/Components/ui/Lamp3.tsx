...
export function LampDemo3 ({phases}) {
  return (
    <LampContainer3>
      <motion.h1
        ...
        className="mt-4 bg-gradient-to-br from-slate-300 to-slate-500 py-4 bg-clip-text text-center text-4xl font-medium tracking-wide text-transparent md:text-7xl"
      >
...
{phases.map((item, index) =>(
    <div key={index} className=" block text-base mt-2">
        <h2 className="text-xl md:text-2xl font-bold text-white-100">{item.heading3}</h2>
